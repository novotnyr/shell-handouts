...
\end{obsah}
\vfill
\begin{tcolorbox}[sharp corners,grow to left by=3mm, grow to right by=3mm, enlarge bottom by=-1mm]
\begin{Verbatim}
sort names.txt | uniq
\end{Verbatim}
\end{tcolorbox}
...
\put(0,0){%
\begin{minipage}{5cm}
if \Em{exit kód príkazu je nula}\\
then\\
...\\
else\\
...\\
...
\begin{tcolorbox}[sharp corners, grow to left by=3mm, leftrule=0mm, rightrule=0mm, grow to right by=3mm, enlarge bottom by=-1mm]
echo "\$HOME"
\end{tcolorbox}
\begin{obsah}
- uvedená dolárom
...
\begin{tcolorbox}[sharp corners, grow to left by=3mm, leftrule=0mm, rightrule=0mm, grow to right by=3mm, enlarge bottom by=-3mm]
MENO='Grace Hopper'
\end{tcolorbox}
\begin{obsah}
...
\begin{tcolorbox}[sharp corners, grow to left by=3mm, leftrule=0mm, rightrule=0mm, grow to right by=3mm]
find . -name '*.c'
\end{tcolorbox}
\begin{tabular}{ll}
\Em{.} & odkiaľ začať\\
...
\put(0,0){%
\begin{minipage}{8cm}
while\VISIBLESPACE[\VISIBLESPACE \hl{príkaz s nulovým exit kódom}\VISIBLESPACE] \\
do\\
...\\
done
\end{minipage}
...
\begin{tcolorbox}[sharp corners, grow to left by=3mm, grow to right by=0mm, leftrule=0mm, rightrule=0.5mm, enlarge bottom by=-1mm]
awk -F\Em{':'} '\{print \}'
\end{tcolorbox}
\end{minipage}
%
...
\begin{tcolorbox}[sharp corners, grow to left by=2mm, grow to right by=3mm, leftrule=0mm, rightrule=0mm, enlarge bottom by=-1mm]
